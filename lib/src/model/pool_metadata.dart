...
class _$PoolMetadataSerializer implements StructuredSerializer<PoolMetadata> {
  ...
  @override
  Iterable<Object?> serialize(Serializers serializers, PoolMetadata object, {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[];
  ...
  @override
  PoolMetadata deserialize(Serializers serializers, Iterable<Object?> serialized, {FullType specifiedType = FullType.unspecified}) {
