      ...
      switch (key) {
        ...
        case r'state':
          result.state = serializers.deserialize(value,
                  specifiedType: const FullType(InlineResponse2005StateEnum))
              as InlineResponse2005StateEnum;
          break;
      }
    }
    return result.build();
...
class InlineResponse2005StateEnum extends EnumClass {
  ...
  static const InlineResponse2005StateEnum
      queuedPipePinnedPipeUnpinnedPipeFailedPipeGc =
      _$inlineResponse2005StateEnum_queuedPipePinnedPipeUnpinnedPipeFailedPipeGc;

  static Serializer<InlineResponse2005StateEnum> get serializer =>
      _$inlineResponse2005StateEnumSerializer;

  const InlineResponse2005StateEnum._(String name) : super(name);

  static BuiltSet<InlineResponse2005StateEnum> get values =>
      _$inlineResponse2005StateEnumValues;
  static InlineResponse2005StateEnum valueOf(String name) =>
      _$inlineResponse2005StateEnumValueOf(name);
}
