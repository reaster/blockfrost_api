...
class _$AddressContentSerializer implements StructuredSerializer<AddressContent> {
    @override
    ...
    Iterable<Object?> serialize(Serializers serializers, AddressContent object,
        ...
        result
            ..add(r'stake_address')
            ..add(object.stakeAddress == null ? null : serializers.serialize(object.stakeAddress,
    ...
    @override
    AddressContent deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
            ...
            switch (key) {
                ...
                case r'type':
                    result.type = serializers.deserialize(value,
                        specifiedType: const FullType(AddressContentTypeEnum)) as AddressContentTypeEnum;
                    break;
            }
        }
        return result.build();
