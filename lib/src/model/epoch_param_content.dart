...
abstract class EpochParamContent
    implements Built<EpochParamContent, EpochParamContentBuilder> {
  ...
  factory EpochParamContent([void updates(EpochParamContentBuilder b)]) =
      _$EpochParamContent;

  @BuiltValueSerializer(custom: true)
  static Serializer<EpochParamContent> get serializer =>
      _$EpochParamContentSerializer();
}

class _$EpochParamContentSerializer
    implements StructuredSerializer<EpochParamContent> {
  @override
  ...
  Iterable<Object?> serialize(Serializers serializers, EpochParamContent object,
    ...
    result
      ..add(r'a0')
      ..add(
          serializers.serialize(object.a0, specifiedType: const FullType(num)));
    result
      ..add(r'rho')
    ...
    result
      ..add(r'extra_entropy')
      ..add(object.extraEntropy == null
          ? null
          : serializers.serialize(object.extraEntropy,
