...
abstract class BlockContent
    implements Built<BlockContent, BlockContentBuilder> {
...
class _$BlockContentSerializer implements StructuredSerializer<BlockContent> {
  ...
  Iterable<Object?> serialize(Serializers serializers, BlockContent object,
    ...
    result
      ..add(r'slot')
      ..add(object.slot == null
          ? null
          : serializers.serialize(object.slot,
              specifiedType: const FullType(int)));
    result
      ..add(r'epoch')
      ..add(object.epoch == null
          ? null
          : serializers.serialize(object.epoch,
              specifiedType: const FullType(int)));
    result
      ..add(r'epoch_slot')
      ..add(object.epochSlot == null
          ? null
          : serializers.serialize(object.epochSlot,
              specifiedType: const FullType(int)));
    result
      ..add(r'slot_leader')
    ...
    result
      ..add(r'output')
      ..add(object.output == null
          ? null
          : serializers.serialize(object.output,
              specifiedType: const FullType(String)));
    result
      ..add(r'fees')
      ..add(object.fees == null
          ? null
          : serializers.serialize(object.fees,
              specifiedType: const FullType(String)));
    result
      ..add(r'block_vrf')
      ..add(object.blockVrf == null
          ? null
          : serializers.serialize(object.blockVrf,
              specifiedType: const FullType(String)));
    result
      ..add(r'previous_block')
      ..add(object.previousBlock == null
          ? null
          : serializers.serialize(object.previousBlock,
              specifiedType: const FullType(String)));
    result
      ..add(r'next_block')
      ..add(object.nextBlock == null
          ? null
          : serializers.serialize(object.nextBlock,
              specifiedType: const FullType(String)));
    result
      ..add(r'confirmations')
