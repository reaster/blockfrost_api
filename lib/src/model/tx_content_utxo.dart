...
abstract class TxContentUtxo
    implements Built<TxContentUtxo, TxContentUtxoBuilder> {
  ...
  factory TxContentUtxo([void updates(TxContentUtxoBuilder b)]) =
      _$TxContentUtxo;

  @BuiltValueSerializer(custom: true)
  static Serializer<TxContentUtxo> get serializer =>
      _$TxContentUtxoSerializer();
}
  ...
  Iterable<Object?> serialize(Serializers serializers, TxContentUtxo object,
    ...
    result
      ...
      ..add(serializers.serialize(object.inputs,
          specifiedType:
              const FullType(BuiltList, [FullType(TxContentUtxoInputs)])));
    result
      ..add(r'outputs')
      ..add(serializers.serialize(object.outputs,
          specifiedType:
              const FullType(BuiltList, [FullType(TxContentUtxoOutputs)])));
    return result;
  }
        ...
        case r'inputs':
          result.inputs.replace(serializers.deserialize(value,
                  specifiedType: const FullType(
                      BuiltList, [FullType(TxContentUtxoInputs)]))
              as BuiltList<TxContentUtxoInputs>);
          break;
        case r'outputs':
          result.outputs.replace(serializers.deserialize(value,
                  specifiedType: const FullType(
                      BuiltList, [FullType(TxContentUtxoOutputs)]))
              as BuiltList<TxContentUtxoOutputs>);
          break;
      }
    }
    return result.build();
