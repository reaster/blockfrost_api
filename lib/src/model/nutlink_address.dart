...
class _$NutlinkAddressSerializer implements StructuredSerializer<NutlinkAddress> {
    @override
    ...
    @override
    NutlinkAddress deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
