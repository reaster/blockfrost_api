            ...
            switch (key) {
                ...
                case r'state':
                    result.state = serializers.deserialize(value,
                        specifiedType: const FullType(InlineResponse2007StateEnum)) as InlineResponse2007StateEnum;
                    break;
            }
        }
        return result.build();
...
class InlineResponse2007StateEnum extends EnumClass {
  ...
  static const InlineResponse2007StateEnum queuedPipePinnedPipeUnpinnedPipeFailedPipeGc = _$inlineResponse2007StateEnum_queuedPipePinnedPipeUnpinnedPipeFailedPipeGc;

  static Serializer<InlineResponse2007StateEnum> get serializer => _$inlineResponse2007StateEnumSerializer;

  const InlineResponse2007StateEnum._(String name): super(name);

  static BuiltSet<InlineResponse2007StateEnum> get values => _$inlineResponse2007StateEnumValues;
  static InlineResponse2007StateEnum valueOf(String name) => _$inlineResponse2007StateEnumValueOf(name);
}
