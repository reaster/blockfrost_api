      ...
      switch (key) {
        ...
        case r'state':
          result.state = serializers.deserialize(value,
                  specifiedType: const FullType(InlineResponse2006StateEnum))
              as InlineResponse2006StateEnum;
          break;
      }
    }
    return result.build();
...
class InlineResponse2006StateEnum extends EnumClass {
  ...
  static const InlineResponse2006StateEnum
      queuedPipePinnedPipeUnpinnedPipeFailedPipeGc =
      _$inlineResponse2006StateEnum_queuedPipePinnedPipeUnpinnedPipeFailedPipeGc;

  static Serializer<InlineResponse2006StateEnum> get serializer =>
      _$inlineResponse2006StateEnumSerializer;

  const InlineResponse2006StateEnum._(String name) : super(name);

  static BuiltSet<InlineResponse2006StateEnum> get values =>
      _$inlineResponse2006StateEnumValues;
  static InlineResponse2006StateEnum valueOf(String name) =>
      _$inlineResponse2006StateEnumValueOf(name);
}
