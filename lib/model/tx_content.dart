...
class _$TxContentSerializer implements StructuredSerializer<TxContent> {
    ...
    Iterable<Object> serialize(Serializers serializers, TxContent object,
        ...
        result
            ...
            ..add(object.invalidBefore == null ? null : serializers.serialize(object.invalidBefore,
                specifiedType: const FullType(String)));
        result
            ..add(r'invalid_hereafter')
            ..add(object.invalidHereafter == null ? null : serializers.serialize(object.invalidHereafter,
                specifiedType: const FullType(String)));
        result
            ..add(r'utxo_count')
