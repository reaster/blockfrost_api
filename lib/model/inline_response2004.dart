            ...
            switch (key) {
                ...
                case r'state':
                    result.state = serializers.deserialize(value,
                        specifiedType: const FullType(InlineResponse2004StateEnum)) as InlineResponse2004StateEnum;
                    break;
            }
        }
        return result.build();
...
class InlineResponse2004StateEnum extends EnumClass {
  ...
  static const InlineResponse2004StateEnum queuedPipePinnedPipeUnpinnedPipeFailedPipeGc = _$inlineResponse2004StateEnum_queuedPipePinnedPipeUnpinnedPipeFailedPipeGc;

  static Serializer<InlineResponse2004StateEnum> get serializer => _$inlineResponse2004StateEnumSerializer;

  const InlineResponse2004StateEnum._(String name): super(name);

  static BuiltSet<InlineResponse2004StateEnum> get values => _$inlineResponse2004StateEnumValues;
  static InlineResponse2004StateEnum valueOf(String name) => _$inlineResponse2004StateEnumValueOf(name);
}
